export default {
    meta: {
        title: "DSH FreeCanvas",
        description: "An AI canvas workspace integrated with DSH",
    },
    ...
    canvas: {
        ...
        export: { defaultProjectName: "DSH FreeCanvas", defaultNodesName: "Canvas elements", item: "Element" },
        createMenu: {
    ...
    home: {
        ...
        description: "Generate, connect, and reshape <content>images, text, and graphics</content> in <canvas>DSH FreeCanvas</canvas>, turning one-off generations into a continuous creative process.",
        start: "Get started",
    ...
    officialAccount: {
        ...
        unavailable: "Official channel is not available",
        unavailableDescription: "This installation has not enabled the official media channel.",
        requestFailed: "Account information is temporarily unavailable",
        loading: "Loading account status",
        stale: "Showing the last successfully loaded account information",
        tokenExpired: "This device connection has expired. Pair again to reconnect.",
        connected: "Official account connected",
        ...
        connectDescription: "Paste the one-time pairing code from your account center.",
        pairCodePlaceholder: "Enter pairing code",
        pairCodeRequired: "Enter a pairing code",
        connect: "Connect account",
        viewBalance: "View points",
        openPortal: "Open account center for a pairing code",
        pairSuccess: "Account connected",
        pairFailed: "Connection result is unconfirmed. Check the account status, then try again.",
        redeemTitle: "Redeem a card",
        cardCodePlaceholder: "Enter the 32-character card code",
        cardCodeRequired: "Enter a card code",
        redeem: "Redeem points",
        redeemSuccess: "Redeemed successfully. Points have been refreshed.",
        redeemFailed: "Redemption result is unconfirmed. Check the latest points before trying again.",
        buyCard: "Buy a card",
        disconnect: "Disconnect account",
        disconnectConfirm: "Disconnect this device from the official account?",
        disconnectSuccess: "Account disconnected",
        disconnectFailed: "Disconnect result is unconfirmed. Check the account status, then try again.",
        privacy: "The account token stays only in the local DSH host. It is never written to browser settings or exported files.",
    },
    config: {
        ...
        localStorage: {
            ...
            description: "View browser data saved by DSH FreeCanvas, grouped by object store.",
            ...
            mainDatabase: "DSH FreeCanvas data",
        ...
        channels: {
            ...
            officialName: "Official media",
            officialDescription: "Official channel · Images + video · Uses account points",
            officialReadonly: "Managed by DSH FreeCanvas",
            add: "Add provider",
    ...
    agent: {
        ...
        connect: { title: "DSH FreeCanvas Agent", description: "DSH Desktop connects to the local Agent started with the plugin automatically. Check the details below only if the connection fails.", webConnection: "Plugin connection", autoDiscover: "DSH Desktop manages the local address and connection token automatically; manual changes are rarely needed.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
