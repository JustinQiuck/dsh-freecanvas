export default {
    meta: {
        ...
        description: "集成到 DSH 的 AI 无限画布工作台",
    },
    theme: { toggle: "切换主题" },
    common: {
        cancel: "取消",
    ...
    canvas: {
        ...
        export: { defaultProjectName: "DSH FreeCanvas", defaultNodesName: "画布元素", item: "元素" },
        createMenu: {
    ...
    home: {
        promptError: "获取提示词失败",
        description: "在 <canvas>DSH FreeCanvas</canvas> 中生成、连接和重组 <content>图片、文字与图形</content>，让创作从单次生成变成连续推演。",
        start: "开始使用",
        openCanvas: "打开画布",
    ...
    officialAccount: {
        title: "官方账户",
        unavailable: "官方渠道暂未开放",
        unavailableDescription: "当前安装尚未启用官方媒体渠道。",
        requestFailed: "账户信息暂时不可用",
        loading: "正在读取账户状态",
        stale: "显示的是上次成功获取的账户信息",
        tokenExpired: "设备连接已过期，请重新配对",
        connected: "已连接官方账户",
        notConnected: "未连接",
        points: "{{points}} 积分",
        pointsUnit: "积分",
        ...
        connectTitle: "连接账户",
        connectDescription: "粘贴从账户中心获得的一次性配对码。",
        pairCodePlaceholder: "输入配对码",
        pairCodeRequired: "请输入配对码",
        connect: "连接账户",
        viewBalance: "查看积分",
        openPortal: "前往账户中心获取配对码",
        pairSuccess: "账户已连接",
        pairFailed: "连接结果未确认，请查看账户状态后重试",
        redeemTitle: "兑换卡密",
        cardCodePlaceholder: "输入 32 位卡密",
        cardCodeRequired: "请输入卡密",
        redeem: "兑换积分",
        redeemSuccess: "兑换成功，积分已刷新",
        redeemFailed: "兑换结果未确认，请核对最新积分后再试",
        buyCard: "购买卡密",
        disconnect: "断开账户",
        disconnectConfirm: "确定断开这台设备与官方账户的连接吗？",
        disconnectSuccess: "已断开账户",
        disconnectFailed: "断开结果未确认，请查看账户状态后重试",
        privacy: "账户令牌只保存在本机 DSH 宿主，不会写入浏览器配置或导出文件。",
    },
    config: {
        title: "配置与用户偏好",
        ...
        localStorage: {
            ...
            description: "查看 DSH FreeCanvas 在浏览器中保存的数据量，并按对象仓库统计内容体积。",
            ...
            mainDatabase: "DSH FreeCanvas 主数据",
            records: "{{count}} 条",
            refresh: "刷新统计",
            readFailed: "读取本地存储失败",
        ...
        channels: {
            ...
            officialName: "官方媒体",
            officialDescription: "官方渠道 · 生图 + 视频 · 使用账户点数",
            officialReadonly: "由 DSH FreeCanvas 管理",
            add: "新增渠道",
            unnamed: "未命名渠道",
    ...
    agent: {
        ...
        connect: { title: "DSH FreeCanvas Agent", description: "DSH Desktop 会自动连接随插件启动的本地 Agent；仅在连接异常时检查下面信息。", webConnection: "插件连接", autoDiscover: "本地地址和连接令牌由 DSH Desktop 自动管理，通常无需手动修改。", disconnect: "断开", connect: "连接", localAddress: "本地地址", urlPlaceholder: "例如 http://127.0.0.1:17371", token: "连接 Token", tokenPlaceholder: "自动发现，或手动填入 Connect token" },
